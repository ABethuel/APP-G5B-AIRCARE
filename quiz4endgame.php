...
<div class = "Resultats">
        ...
        <h1 class = "scorefinal" id = "finalScore">0</h1>
        <button class="EndButton" onclick="window.location.href='/quiz4.php';">Rejouer</button>
...
<?php include_once('./Components/footer.php'); ?>
    ...
    <script src="./scripts/quiz4endgame.js"></script>
<body>
