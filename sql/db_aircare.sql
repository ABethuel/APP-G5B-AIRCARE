...
-- --------------------------------------------------------
CREATE DATABASE `gywulo_aircare` ;

--
-- Structure de la table `air_quality`
--

DROP TABLE IF EXISTS `gywulo_aircare`.`air_quality`;
CREATE TABLE IF NOT EXISTS `gywulo_aircare`.`air_quality` (
...
INSERT INTO `gywulo_aircare`.`air_quality` (`id`, `id_captor`, `id_particles`, `id_monoxide`, `id_nitrogen`, `place`, `result`, `quality`, `date`) VALUES
...
DROP TABLE IF EXISTS `gywulo_aircare`.`bpm`;
CREATE TABLE IF NOT EXISTS `gywulo_aircare`.`bpm` (
  `id` int NOT NULL AUTO_INCREMENT,
...
INSERT INTO `gywulo_aircare`.`bpm` (`id`, `id_user`, `value`, `quality`) VALUES
(1, 16, 85, 'normale'),
(2, 16, 108, 'élevé');
...
DROP TABLE IF EXISTS `gywulo_aircare`.`captors`;
CREATE TABLE IF NOT EXISTS `gywulo_aircare`.`captors` (
  `id` int NOT NULL AUTO_INCREMENT,
...
INSERT INTO `gywulo_aircare`.`captors` (`id`, `title`, `description`, `place`, `date`, `image`, `user_id`, `user_name`) VALUES
...
DROP TABLE IF EXISTS `gywulo_aircare`.`carbon_monoxide`;
CREATE TABLE IF NOT EXISTS `gywulo_aircare`.`carbon_monoxide` (
  `id` int NOT NULL AUTO_INCREMENT,
...
INSERT INTO `gywulo_aircare`.`carbon_monoxide` (`id`, `captor_id`, `value`, `percentage`) VALUES
(1, 2, 30, 100);
...
DROP TABLE IF EXISTS `gywulo_aircare`.`email`;
CREATE TABLE IF NOT EXISTS `gywulo_aircare`.`email` (
  `id` int NOT NULL AUTO_INCREMENT,
...
INSERT INTO `gywulo_aircare`.`email` (`id`, `email`, `sujet`, `message`, `status`) VALUES
...
DROP TABLE IF EXISTS `gywulo_aircare`.`faq`;
CREATE TABLE IF NOT EXISTS `gywulo_aircare`.`faq` (
  `id` int NOT NULL AUTO_INCREMENT,
...
INSERT INTO `gywulo_aircare`.`faq` (`id`, `question`, `answer`) VALUES
...
DROP TABLE IF EXISTS `gywulo_aircare`.`fine_particles`;
CREATE TABLE IF NOT EXISTS `gywulo_aircare`.`fine_particles` (
  `id` int NOT NULL AUTO_INCREMENT,
  `captor_id` int NOT NULL,
  `value` float NOT NULL,
  `percentage` float NOT NULL,
...
INSERT INTO `gywulo_aircare`.`fine_particles` (`id`, `captor_id`, `value`, `percentage`) VALUES
(1, 2, 35, 100);
...
DROP TABLE IF EXISTS `gywulo_aircare`.`messages`;
CREATE TABLE IF NOT EXISTS `gywulo_aircare`.`messages` (
  `id` int NOT NULL AUTO_INCREMENT,
...
INSERT INTO `gywulo_aircare`.`messages` (`id`, `content`, `date`, `user_id`, `user_name`, `topic_id`) VALUES
...
DROP TABLE IF EXISTS `gywulo_aircare`.`news`;
CREATE TABLE IF NOT EXISTS `gywulo_aircare`.`news` (
  `id` int NOT NULL AUTO_INCREMENT,
...
INSERT INTO `gywulo_aircare`.`news` (`id`, `image`, `title`, `description`, `link`) VALUES
...
DROP TABLE IF EXISTS `gywulo_aircare`.`nitrogen_dioxide`;
CREATE TABLE IF NOT EXISTS `gywulo_aircare`.`nitrogen_dioxide` (
  `id` int NOT NULL AUTO_INCREMENT,
  `captor_id` int NOT NULL,
  `value` float NOT NULL,
  `percentage` float NOT NULL,
...
INSERT INTO `gywulo_aircare`.`nitrogen_dioxide` (`id`, `captor_id`, `value`, `percentage`) VALUES
(1, 2, 213, 100);
