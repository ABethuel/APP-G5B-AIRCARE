...
DROP TABLE IF EXISTS `db_aircare`.`email`;
CREATE TABLE IF NOT EXISTS `db_aircare`.`email` (
  `id` int NOT NULL AUTO_INCREMENT,
...
INSERT INTO `db_aircare`.`email` (`id`, `email`, `sujet`, `message`, `status`) VALUES
...
INSERT INTO `db_aircare`.`faq` (`id`, `question`, `answer`) VALUES
