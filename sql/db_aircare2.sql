...
CREATE TABLE `db_aircare`.`captors` (
...
CREATE TABLE `db_aircare`.`messages` (
  `id` int(11) NOT NULL AUTO_INCREMENT,
...
CREATE TABLE `db_aircare`.`topics` (
  `id` int(11) NOT NULL AUTO_INCREMENT,
  `title` varchar(255) NOT NULL,
  `date` datetime NOT NULL,
  `user_id` int(11) NOT NULL,
