                                    ...
                                    while($faq = $recupFAQ->fetch()){
                                        ...
                                        <div class="FAQ">
                                            ...
                                            <div class="buttonFAQ">
                                                ...
                                                <button  class="supprimer" id="supprimerFAQ"  onclick="if(confirm('Etes-vous sûr de vouloir supprimer cette question/réponse ?')){}else{return false;}">Supprimer cette question-réponse</button>
                                                </form>
                                            </div>
